package com.ygq.itemdecoration;
...
/** Created by yeguoqiang on 2020/05/08. */
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    /**
     * In the case mShowLastDivider = false, Returns offset for how many views we don't have to draw
     * a divider for, for LinearLayoutManager it is as simple as not drawing the last child divider,
    ...
    /**
     * Determines whether divider was already drawn for the row the item is in, effectively only
     * makes sense for a grid
     *
    ...
    /**
     * Returns a group index for GridLayoutManager. for LinearLayoutManager, always returns
     * position.
     *
     * @param position current view position to draw divider
     * @param parent RecyclerView
